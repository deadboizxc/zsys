...
│   ├── __init__.py
│   │
│   ├── pyrogram/              # Pyrogram реализация (userbots)
│   │   ├── __init__.py
│   │   └── client.py         # PyrogramClient: IUserBot
│   │
│   ├── aiogram/               # Aiogram реализация (bots)
│   │   ├── __init__.py
│   │   └── bot.py            # AiogramBot: IBot
│   │
│   └── telethon/              # Telethon реализация (userbots)
│       ├── __init__.py
│       └── client.py         # TelethonClient: IUserBot
│
├── storage/                    # 💾 Storage модули
│   ├── __init__.py
...
### ✅ 1. Core (maksimalnaya abstraktsiya)
