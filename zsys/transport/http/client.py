...
class HttpClient(BaseHttpClient):
    ...
    def __init__(
        ...
        self._client_type = "aiohttp" if AIOHTTP_AVAILABLE else "httpx" if HTTPX_AVAILABLE else None
    ...
    async def _request_with_retry(self, method: str, url: str, **kwargs) -> Any:
        ...
        for attempt in range(config.max_retries + 1):
            try:
                ...
                status = response.status if self._client_type == "aiohttp" else response.status_code
