...
TG_ERROR_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_int, ctypes.c_char_p, ctypes.c_void_p
)
TG_MESSAGE_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p
)
TG_RAW_FN = ctypes.CFUNCTYPE(None, ctypes.c_void_p, ctypes.c_char_p, ctypes.c_void_p)
TG_PROGRESS_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_int32, ctypes.c_int64, ctypes.c_int64, ctypes.c_void_p
)

# New async / bot callback types
TG_RESULT_FN = ctypes.CFUNCTYPE(None, ctypes.c_void_p, ctypes.c_char_p, ctypes.c_void_p)
TG_USER_CB_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p
)
TG_CHAT_CB_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p
)
TG_MEMBER_CB_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p
)
TG_MEMBERS_CB_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p
)
TG_MESSAGES_CB_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p
)
TG_FILE_CB_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p
)
TG_DIALOGS_CB_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p
)
TG_CALLBACK_QUERY_FN = ctypes.CFUNCTYPE(
    None,
    ctypes.c_void_p,
    ctypes.c_int64,
    ctypes.c_int64,
...
TG_INLINE_QUERY_FN = ctypes.CFUNCTYPE(
    None,
    ctypes.c_void_p,
    ctypes.c_int64,
    ctypes.c_int64,
...
TG_MEMBER_EVENT_FN = ctypes.CFUNCTYPE(
    None, ctypes.c_void_p, ctypes.c_int64, ctypes.c_void_p, ctypes.c_void_p
)
...
class _LibTg:
    ...
    def _setup_signatures(self, lib: ctypes.CDLL) -> None:
        ...
        lib.tg_delete_msg.argtypes = [ctypes.c_void_p, ctypes.c_int64, ctypes.c_int64]
        lib.tg_forward.restype = ctypes.c_int
        lib.tg_forward.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_int64,
            ctypes.c_int64,
        ...
        lib.tg_send_animation.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
            ctypes.c_char_p,
        ...
        lib.tg_send_sticker.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
        ]
        lib.tg_send_voice.restype = ctypes.c_int
        lib.tg_send_voice.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
            ctypes.c_char_p,
        ...
        lib.tg_send_video_note.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
        ]
        lib.tg_send_location.restype = ctypes.c_int
        lib.tg_send_location.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_double,
            ctypes.c_double,
        ...
        lib.tg_send_dice.argtypes = [ctypes.c_void_p, ctypes.c_int64, ctypes.c_char_p]
        lib.tg_send_chat_action.restype = ctypes.c_int
        lib.tg_send_chat_action.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
        ]
        lib.tg_copy_message.restype = ctypes.c_int
        lib.tg_copy_message.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_int64,
            ctypes.c_int64,
        ...
        lib.tg_delete_messages.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_void_p,
            ctypes.c_int,
        ...
        lib.tg_search_public_chat.argtypes = [
            ctypes.c_void_p,
            ctypes.c_char_p,
            TG_CHAT_CB_FN,
            ctypes.c_void_p,
        ...
        lib.tg_set_chat_title.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
        ]
        lib.tg_set_chat_description.restype = ctypes.c_int
        lib.tg_set_chat_description.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
        ]
        lib.tg_set_chat_photo.restype = ctypes.c_int
        lib.tg_set_chat_photo.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_char_p,
        ]
        ...
        lib.tg_mute_chat.argtypes = [ctypes.c_void_p, ctypes.c_int64, ctypes.c_int]
        lib.tg_get_invite_link.restype = ctypes.c_int
        lib.tg_get_invite_link.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            TG_RAW_FN,
            ctypes.c_void_p,
        ...
        lib.tg_unban_member.argtypes = [ctypes.c_void_p, ctypes.c_int64, ctypes.c_int64]
        lib.tg_restrict_member.restype = ctypes.c_int
        lib.tg_restrict_member.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_int64,
            ctypes.c_uint32,
        ...
        lib.tg_promote_member.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_int64,
            ctypes.c_uint32,
        ...
        lib.tg_set_chat_permissions.argtypes = [
            ctypes.c_void_p,
            ctypes.c_int64,
            ctypes.c_uint32,
        ]
        lib.tg_kick_member.restype = ctypes.c_int
        lib.tg_kick_member.argtypes = [ctypes.c_void_p, ctypes.c_int64, ctypes.c_int64]
        ...
        lib.tg_update_profile.argtypes = [
            ctypes.c_void_p,
            ctypes.c_char_p,
            ctypes.c_char_p,
            ctypes.c_char_p,
