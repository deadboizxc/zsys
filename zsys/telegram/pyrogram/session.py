...
def get_session_path(
    session_name: str, workdir: Optional[str] = None, extension: str = ".session"
) -> Path:
    """
...
def validate_session(session_name: str, workdir: Optional[str] = None) -> bool:
    """
...
async def create_session(
    ...
    try:
        ...
        raise ImportError(
            "pyrogram is required for session creation. Install with: pip install pyrogram"
        )
